...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='golem_app/constants.proto',
  package='golem_app',
  syntax='proto3',
...
RESOURCES_DIR = _descriptor.FieldDescriptor(
  name='RESOURCES_DIR', full_name='golem_app.RESOURCES_DIR', index=0,
...
NETWORK_RESOURCES_DIR = _descriptor.FieldDescriptor(
  name='NETWORK_RESOURCES_DIR', full_name='golem_app.NETWORK_RESOURCES_DIR', index=1,
...
RESULTS_DIR = _descriptor.FieldDescriptor(
  name='RESULTS_DIR', full_name='golem_app.RESULTS_DIR', index=2,
...
NETWORK_RESULTS_DIR = _descriptor.FieldDescriptor(
  name='NETWORK_RESULTS_DIR', full_name='golem_app.NETWORK_RESULTS_DIR', index=3,
